    ...
    <section id="features biodata-container" class="features">
      <div class="container " data-aos="fade-up">
        <div class="row feature-item">
          ...
          <form id="msform" class="msform-general">
       <!-- progressbar -->
            <div class="stickyprogress">
              <ul id="progressbar">
             ...
             <!-- fieldsets -->
             <fieldset class="gerenal-fieldset">
               ...
               <h3 class="fs-subtitle">আপনার সাধারণ তথ্যাবলী</h3>
                 <div class="form-flex">
                    ...
                    <div>
                        <select class="form-input" name="keg_type" >
                          <option value="" ></option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="স্থায়ী ঠিকানা লিখুন" />
                        <select class="form-input" name="keg_type" placeholder="Pickup Date">
                          <option value="" ></option>
                            <option value="চট্টগ্রাম">চট্টগ্রাম</option>
                            <option value="ঢাকা">ঢাকা</option>
                            <option value="খুলনা">খুলনা</option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="বর্তমান ঠিকানা লিখুন" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="জাতীয়তা লিখুন" />
                        <input class="form-input" type="date" name="pickup_date" placeholder="জন্ম তারিখ দেন" />
                        <select class="form-input" name="keg_type" >
                          <option value="" ></option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="নিজের ওজন লিখুন" />
                        <select class="form-input" name="keg_type" >
                          <option value="" ></option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="পেশা লিখুন, যেমনঃ সাংবাদিক বা ছাত্র/ছাত্রী" />
                        <textarea class="form-input" type="textare" name="pickup_date" placeholder="পেশার বর্ণনা সংক্ষেপে"></textarea>
             ...
             <fieldset class="education-fieldset">
               ...
               <div class="form-flex">
                    ...
                    <div>
                        ...
                        <input class="form-input" type="text" name="" placeholder="শিক্ষা বোর্ড" />
                        <input class="form-input" type="text" name="" placeholder="মাধ্যমিক বা সমমান পাশ" />
                        <select class="form-input" name="keg_type" >
                          <option value="" ></option>
                        ...
                        <input class="form-input" type="text" name="" placeholder="মাধ্যমিক বা সমমান পাশের সন" />
                        <input class="form-input" type="text" name="" placeholder="উচ্চ মাধ্যমিক বা সমমান পাশ" />
                        <select class="form-input" name="" >
                          <option value="" ></option>
                          <option value="বিজ্ঞান">বিজ্ঞান</option>
                          <option value="ব্যবসায় শিক্ষা">ব্যবসায় শিক্ষা</option>
                        ...
                        <input class="form-input" type="text" name="" placeholder="উচ্চ মাধ্যমিক বা সমমান পাশের সন" />
                        <input class="form-input" type="text" name="" placeholder="স্নাতক বা সমমান শিক্ষাগত যোগ্যতা" />
                        <input class="form-input" type="text" name="" placeholder="উচ্চ শিক্ষা প্রতিষ্ঠানের নাম" />
                        <input class="form-input" type="text" name="" placeholder="স্নাতক বা সমমান শিক্ষা পাশের সন" />
                        <textarea class="form-input" type="text" name="" placeholder="অন্যান্য শিক্ষাগত যোগ্যতা যদি থাকে"></textarea>
                    </div>
                 </div>
                  
                  <input id="form-button-41" type="button" name="" class="previous action-button" value="Previous" />
             ...
             <fieldset class="family-fieldset">
               ...
               <div class="form-flex">
                    ...
                    <div>
                        <input class="form-input" type="text" name="pickup_date" placeholder="পিতার নাম" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="মাতার নাম" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="পিতার পেশা" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="মাতার পেশা" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="বোন সম্পর্কে লিখুন" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="ভাই সম্পর্কে লিখুন" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="চাচা বা মামাদের সম্পর্কে লিখুন" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="নিজের অর্থনৈতিক ও সামাজিক অবস্থান লিখুন" />
             ...
             <fieldset class="personalinfo-fieldset">
               ...
               <div class="form-flex">
                    ...
                    <div>
                        <select class="form-input" name="" >
                          <option value="" ></option>
                          <option value="">হ্যাঁ, সুন্নতি দাঁড়ি রাখছি</option>
                          <option value="">না, দাড়ি নাই</option>
                        </select>
                        <select class="form-input" name="" >
                          <option value="" ></option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="কখন থেকে সালাত নিয়মিত পড়েন।।" />
                        <select class="form-input" name="" >
                          <option value="" ></option>
                          <option value="">হ্যাঁ </option>
                          <option value="">না</option>
                        ...
                        <input class="form-input" type="text" name="pickup_date" placeholder="মাযহাবের অনুসরণ থাকলে লিখুন" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="" />
                        <input class="form-input" type="text" name="pickup_date" placeholder="" />
                        <textarea class="form-input" type="text" name="pickup_date" placeholder=""></textarea>
                    </div>
                 </div>
             ...
             <fieldset class="maritalinfo-fieldset">
             ...
             <fieldset class="professional-fieldset">
               ...
               <div class="form-flex">
                    ...
                    <div>
                        <textarea class="form-input" type="text" name="pickup_date" placeholder="Pickup Date"></textarea>
                    </div>
                 </div>
               <!--<textarea name="address" placeholder="Address"></textarea>-->
             ...
             <fieldset class="prefered-lifepartner-fieldset">
               ...
               <div class="form-flex ">
                    ...
                    <div>
                        <input class="form-input" type="text" name="" placeholder="কাঙ্খিত সর্বোচ্চ বয়স" />
                        <input class="form-input" type="text" name="" placeholder=" গায়ের বর্ণ" />
                        <input class="form-input" type="text" name="" placeholder="ন্যূনতম উচ্চতা কত চান" />
                        <input class="form-input" type="text" name="" placeholder="ন্যূনতম শিক্ষাগত যোগ্যতা" />
                        <input class="form-input" type="text" name="" placeholder="জেলার নামে" />
                        <input class="form-input" type="text" name="" placeholder="বৈবাহিক অবস্থা কেমন চান" />
                        <input class="form-input" type="text" name="" placeholder="পেশা কি হবে চান" />
                        <input class="form-input" type="text" name="" placeholder="অর্থনৈতিক অবস্থা কেমন চান" />
                        <input class="form-input" type="text" name="" placeholder="কাঙ্ক্ষিত পরিবার কেমন চান" />
                        <textarea class="form-input" type="text" name="pickup_date" placeholder="" ></textarea>
                    </div>
                 </div>
               <!--<textarea name="address" placeholder="Address"></textarea>-->
               <input id="form-button-71" type="button" name="previous" class="previous action-button" value="Previous" />
               <input id="form-button-7" type="submit" name="submit" class="submit action-button" value="Submit" id="form-submit" />
             </fieldset>
           </form>
